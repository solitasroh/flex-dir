...
닫혔다** (2026-08-21 · 아래 §다음 작업 0-0). 2구간(v0.8.5)은 외부 도구다 (아래 §다음 작업).
...
버전     0.8.5   릴리스는 v0.1.0 ~ v0.7.0 까지 나갔다. **v0.8.0~v0.8.5 은 패키지만
                 ...
                 ⚠ **0.8.5 은 아직 굽지 않았다** — `Directory.Build.props` 의 버전만
...
### 0. 2구간(v0.8.5) 외부 도구 — 코드는 끝났다. **사람 확인 전**

게이트 4종 ✅ · 테스트 **2277** ✅ (2026-08-24). 전문은 `docs/PRD-v2.md` §21 · `ADR-022` ·
step 목록은 `phases/5-external-tools/index.json`. **버전은 `0.8.5` 으로 올렸고 아직 굽지
